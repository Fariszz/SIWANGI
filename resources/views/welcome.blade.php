    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand fw-bold" href="/">SIWANGI</a>
    ...
    <header class="bg-dark hero-image py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-3 fw-bolder">SIWANGI Product</h1>
                <p class="lead fw-normal text-white-50 mb-0 mt-3">Menyediakan Segala Macam Parfum</p>
            </div>
        </div>
    </header>
    <!-- Section-->
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; SIWANGI Product 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
